...
function InitialFill() {
  ...
  if(Family=='Langton') {
    ...
    if(cfg.debug==1) {
      ...
      var vv = 0;
      SetCell( 9, 4, 0, (-4000 + 32768) + ( 0 + 32768) * 65536, (    0 + 32768) + ( 50 + 32768) * 65536, 0, 1 << 8);
      SetCell(10, 4, 0, (    0 + 32768) + ( 0 + 32768) * 65536, (    0 + 32768) + (  0 + 32768) * 65536, 0, 3 << 8);
      //SetCell(11, 4, 0, ( 4000 + 32768) + ( 0 + 32768) * 65536, (    0 + 32768) + (  0 + 32768) * 65536, 0, 1 << 8);
      SetCell(10, 3, 0, (    0 + 32768) + (80 + 32768) * 65536, (-3000 + 32768) + (  0 + 32768) * 65536, 0, 2 << 8);
