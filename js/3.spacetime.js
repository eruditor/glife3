...
function InitialFill() {
  ...
  if(Family=='Langton') {
    ...
    if(cfg.debug==1) {
      ...
      SetCell( 5, 3, 0, (0 + 32768) + (210 + 32768) * 65536, (0 + 32768) + ( 120 + 32768) * 65536, 0, (1 << 1) + 1);
      SetCell( 5, 5, 0, (0 + 32768) + (200 + 32768) * 65536, (0 + 32768) + (   0 + 32768) * 65536, 0, (2 << 1) + 1);
      SetCell( 5, 7, 0, (0 + 32768) + (220 + 32768) * 65536, (0 + 32768) + (-105 + 32768) * 65536, 0, (1 << 1) + 1);
