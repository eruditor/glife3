...
function InitialFill() {
  ...
  if(Family=='Langton') {
    ...
    if(cfg.debug==1) {
      var vv = 215;
      SetCell( 9, 4, 0, (2000 + 32768) + (vv + 32768) * 65536, (2000 + 32768) + (-vv + 32768) * 65536, 0, 1 << 16);
      SetCell(10, 5, 0, (   0 + 32768) + ( 0 + 32768) * 65536, (   0 + 32768) + (  0 + 32768) * 65536, 0, 3 << 16);
    }
    else if(cfg.debug==2) {
      var vv = 215;
      SetCell( 8, 3, 0, (   0 + 32768) + (vv + 32768) * 65536, (   0 + 32768) + ( vv + 32768) * 65536, 0, 1 << 16);
      SetCell( 8, 5, 0, (   0 + 32768) + (vv + 32768) * 65536, (   0 + 32768) + (  0 + 32768) * 65536, 0, 2 << 16);
      SetCell( 8, 7, 0, (   0 + 32768) + (vv + 32768) * 65536, (   0 + 32768) + (-vv + 32768) * 65536, 0, 3 << 16);
    }
    else if(cfg.debug==3) {
      var vv = 0;
      SetCell( 9, 4, 0, (-4000 + 32768) + (vv + 32768) * 65536, (   0 + 32768) + (-vv + 32768) * 65536, 0, 1 << 16);
      SetCell(10, 4, 0, (    0 + 32768) + ( 0 + 32768) * 65536, (   0 + 32768) + (  0 + 32768) * 65536, 0, 3 << 16);
    }
    else {
      for(var z=0; z<FD; z++) {
        for(var x=round(FW/2-FW*LF/2); x<round(FW/2+FW*LF/2); x++) {
          for(var y=round(FH/2-FH*LF/2); y<round(FH/2+FH*LF/2); y++) {
            ...
            if(rndF(0,Lstep)<density) {
              ...
              var vx = rndF( -round(mL/10),  round(mL/10)) + 32768;
              var vy = rndF( -round(mL/10),  round(mL/10)) + 32768;
